...
| **Needle In A Haystack(needle)** | 長文の中に「秘密の数字は 603904 です」のような短い情報を埋め込み、文末で「秘密の数字は?」と問うて抽出できるかを測る手法。**長文検索能力**を見るベンチマーク。詳細は [docs/06-evaluation.md §7.3](docs/06-evaluation.md) |
